...
# CONFIG
# =====================
DATASET_FILE = "new_data.json"  # same JSON file used for generation
FOLDERS = {
    "CoT": "outputs/deepseek_CoT",
    "SelfDebug": "outputs/deepseek_SelfDebug"
}
...
def main():
    ...
    for strategy, folder in FOLDERS.items():
        output_json = f"results_pass1_deepseek_{strategy}.json"
