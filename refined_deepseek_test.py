...
# CONFIG
# =====================
DATASET_FILE = "refined_prompt_dataset.json"  # same JSON file used for generation
FOLDERS = {
    "CoT": "refined_outputs/deepseek_CoT",
    "SelfDebug": "refined_outputs/deepseek_SelfDebug"
}
...
def main():
    ...
    for strategy, folder in FOLDERS.items():
        output_json = f"refined_results_pass1_deepseek_{strategy}.json"
